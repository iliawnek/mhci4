...
import uk.ac.gla.shopping.ui.camera.*;
import uk.ac.gla.shopping.R;
import uk.ac.gla.shopping.visionprocessor.OCRDetectorProcessor;
...
public class OCRFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Toast toast = Toast.makeText(getActivity().getApplicationContext(), "Position product label text inside the viewfinder to translate",
                Toast.LENGTH_LONG);
